...
<template>
  <div class="form-background">
    <div class="form-container">
      <FormInput v-model="event.title" title="Name des Events" placeholder="Name des Events" type="text" maxlength="255"/>
      <FormInput v-model="event.description" title="Beschreibung" placeholder="Beschreibung" type="textarea" maxlength="1024"/>
